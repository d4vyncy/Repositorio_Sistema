<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CU_Acceder.ascx.cs"
    Inherits="rwebSeguridad.ControlesUsuario.CU_Acceder" %>
...
<body class="fondo">
    ...
    <table align="center">
        ...
        <tr>
            ...
            &nbsp;
                <telerik:RadButton ID="btnVerLlamadas" runat="server" Text="Ver Llamadas" HoveredCssClass="goButtonClassHov"
                    CausesValidation="true" ValidationGroup="FormValidationGroup" 
                    OnClick="btnVerLlamadas_Click">
                    <Icon PrimaryIconUrl="~/img/IconSeleccionar.png" PrimaryIconWidth="15px" PrimaryIconHeight="15px"
                        PrimaryIconTop="4px" PrimaryIconLeft="3px" />
                </telerik:RadButton>
            &nbsp;<telerik:RadButton ID="btnFolio" runat="server" Text="Folios" HoveredCssClass="goButtonClassHov"
                    CausesValidation="true" ValidationGroup="FormValidationGroup" 
                    OnClick="btnFolio_Click">
                    <Icon PrimaryIconUrl="~/img/IconSeleccionar.png" PrimaryIconWidth="15px" PrimaryIconHeight="15px"
                        PrimaryIconTop="4px" PrimaryIconLeft="3px" />
                </telerik:RadButton>
            </td>
