...
{
    public partial class CUP_Refrigerio : System.Web.UI.UserControl
    {
        ...
        void LlenarMarcajes()
        {
            ...
            DataTable dtMar;
            if (chkMes.Checked)
                dtMar = oServicepersonal.ProcedureParametro("pavRegistroDeRefrigerio", "NCodigo", txtCodigo.Text, "AFecha", rddlAnio.SelectedValue.ToString(), "MFecha", rddlMes.SelectedValue.ToString(), "OFecha", "asc", "T", "", "T", "", "T", "", "T", "").Tables[0];
            else
                dtMar = oServicepersonal.ProcedureParametro("pavRegistroDeRefrigerio", "NCodigo", txtCodigo.Text, "DFecha", Fecha.Month.ToString() + "/" + Fecha.Day.ToString() + "/" + Fecha.Year.ToString(), "OFecha", "asc", "T", "", "T", "", "T", "", "T", "", "T", "").Tables[0];
