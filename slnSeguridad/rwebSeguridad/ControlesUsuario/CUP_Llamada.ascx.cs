...
{
    public partial class CUP_Llamada : System.Web.UI.UserControl
    {
        ...
        void LlenarMarcajes()
        {
            ...
            dtMar = oServicepersonal.ProcedureParametro("paviConsultaTelefonoLlamada", "NCodigo", txtCodigo.Text, "NAnio", rddlAnio.SelectedValue.ToString(), "NMes", rddlMes.SelectedValue.ToString(), "ODestino", "asc", "T", "", "T", "", "T", "", "T", "").Tables[0];
                ...
                case "Destino":
                    {
                        ...
                        string ss = dataItem.GetDataKeyValue("Destino").ToString();
                        ...
                        gvLecturaReloj.MasterTableView.DetailTables[0].DataSource = servicePersonal.ProcedureParametro("pavLlamada",
                            "LDestino", dataItem.GetDataKeyValue("Destino").ToString(), "NAnio", rddlAnio.SelectedValue.ToString(), "NMes", rddlMes.SelectedValue.ToString()
        ...
        protected void btnRegistrarLlamadas_Click1(object sender, EventArgs e)
        {
            Server.Transfer("wfReporteLlamadas.aspx");
        }
    }
}