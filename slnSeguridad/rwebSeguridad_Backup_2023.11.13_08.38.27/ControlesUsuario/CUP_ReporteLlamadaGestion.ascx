<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CUP_ReporteLlamadaGestion.ascx.cs" Inherits="rwebSeguridad.ControlesUsuario.CUP_ReporteLlamadaGestion" %>
        ...
        <tr>
            <td colspan="2">
                <table id="TablaDetalle" class="TablaDetalle" cellspacing="1" cellpadding="1" width="100%"
                    ...
                    <tr>
                        <td class="font-blue">
                            <label id="rlblNombreRol0" runat="server">
                                <strong>*Número</strong> :</label>
                        </td>
                        <td>
                            <telerik:RadTextBox Width="200px" ID="rtxtDestino" runat="server" Text='<%#DataBinder.Eval( Container, "DataItem.Destino") %>'
                    ...
                    <tr>
                        <td class="font-blue">
                            <label id="rlblNombreRol" runat="server">
                                <strong>*Propiedad</strong> :</label>
                        </td>
                        <td>
                            <telerik:RadTextBox Width="200px" ID="rtxtPropiedad" runat="server" Text='<%#DataBinder.Eval( Container, "DataItem.Propiedad") %>'
                                TabIndex="1">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="font-blue">
                            <label id="rlblSistema" runat="server">
                                <strong>*Asunto</strong> :</label>
                        </td>
                        <td>
                            <telerik:RadTextBox Width="200px" ID="rtxtAsunto" runat="server" Text='<%#DataBinder.Eval( Container, "DataItem.Asunto") %>'
                                TabIndex="1">
                            </telerik:RadTextBox>
                        </td>
                    </tr>
