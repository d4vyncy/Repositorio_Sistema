<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CUP_Refrigerio.ascx.cs"
    Inherits="rwebSeguridad.ControlesUsuario.CUP_Refrigerio" %>
            ...
            <tr>
                ...
                <td>
                    <telerik:RadComboBox ID="rddlAnio" runat="server" Culture="es-ES" 
                        ...
                        Enabled="False" onselectedindexchanged="rddlMes_SelectedIndexChanged">
                        <Items>
                            <telerik:RadComboBoxItem runat="server"  Owner="rddlAnio" Text="2022" Value="2022" />
            ...
            <tr>
                <td colspan="5">
                    <asp:Label ID="lblMensaje" Font-Bold="True" runat="server" Font-Names="Courier New"
                        Font-Italic="True" Font-Size="Small">Refrigerio </asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="5">
                    <telerik:RadGrid ID="gvLecturaReloj" runat="server" AllowFilteringByColumn="true"
                        ...
                        <MasterTableView TableLayout="Auto" Width="100%" DataKeyNames="Fecha" >
                            ...
                            <Columns>
                                ...
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                    DataField="HoraIngresoM" HeaderText="Ingreso " ShowFilterIcon="false" UniqueName="HoraIngresoM"
                                    DataFormatString="{0:HH:mm:ss}">
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                    DataField="HoraSalidaM" HeaderText="Salida " ShowFilterIcon="false" UniqueName="HoraSalidaM"
                                    DataFormatString="{0:HH:mm:ss}">
                                </telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"
                                    DataField="Observaciones" HeaderText="Observaciones" ShowFilterIcon="false" UniqueName="Observaciones">
                                </telerik:GridBoundColumn>
            ...
            <tr>
                <td colspan="5">
                    <asp:Label ID="lblMinutosAtraso" Font-Bold="True" runat="server" Font-Names="Courier New"
                        Font-Italic="True" Font-Size="Small" Visible="false">---</asp:Label>
                </td>
            </tr>
        </table>
    </div>
