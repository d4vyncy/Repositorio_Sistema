...
{
DbCommand cmd = db.GetStoredProcCommand("pagRol",2, pRol.IdRol, pRol.NombreRol, pRol.IdSistema);
...
{
DbCommand cmd = db.GetStoredProcCommand("pagRol",1, pRol.IdRol, pRol.NombreRol, pRol.IdSistema);
int nIdRol = 0;
...
{
DbCommand cmd = db.GetStoredProcCommand("pagRol",3, pPaq.IdRol, pPaq.NombreRol, pPaq.IdSistema);
return db.ExecuteNonQuery(cmd);
}

public int EliminaRol(clsRolBE pRol)
{
DbCommand cmd = db.GetStoredProcCommand("pagRol",4, pRol.IdRol, pRol.NombreRol, pRol.IdSistema);
return db.ExecuteNonQuery(cmd);
}
